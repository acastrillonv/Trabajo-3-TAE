...
En la Tabla 35, podemos observar que se tiene también el conteo de los accidentes tipo "Choque" producidos en cada barrio de las diferentes comunas . Esto se hizo ya que también se crea columna un valor que nos permitirá crear la clasificación en la agrupación. Este valor es un promedio de de los diferentes tipos de accidentes multiplicados por un peso. Estos pesos fueron seleccionados por nosotros los cuales son:
...
```{r}
#pander(summary(grupo1))
```

<center>**Tabla 36.** Resumen de grupo con clasificación = 1</center>

<br>

```{r}
#pander(summary(grupo2))
```

<center>**Tabla 37.** Resumen de grupo con clasificación = 2</center>

<br>

```{r}
#pander(summary(grupo3))
```

<center>**Tabla 38.** Resumen de grupo con clasificación = 3</center>

<br>

```{r}
#pander(summary(grupo4))
```

<center>**Tabla 39.** Resumen de grupo con clasificación = 4</center>
